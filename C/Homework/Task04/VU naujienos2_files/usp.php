...
jQuery(document).ready(function($) {
	...
	$('#user-submitted-post').click(function() {
		...
		var usp_response = /2/i;
		if (usp_captcha.match(usp_response)) {
			$('.usp-input-error-captcha').remove();
			return true;
		} else {
			$('.usp-input-error-captcha').remove();
			$('.usp-captcha').append('<div class="usp-input-error usp-input-error-captcha"><span>Neteisingas atsakymas</span></div>');
			return false;
		}
	});
...
!function(d){var h=function(a){this.messages={defaultMessage:"This value seems to be invalid.",type:{email:"This value should be a valid email.",url:"Įveskite teisingą adresą",urlstrict:"Įveskite teisingą adresą",number:"This value should be a valid number.",digits:"This value should be digits.",dateIso:"This value should be a valid date (YYYY-MM-DD).",alphanum:"This value should be alphanumeric.",phone:"This value should be a valid phone number."},notnull:"This value should not be null.",
notblank:"This value should not be blank.",required:"Šis laukelis privalomas",regexp:"This value seems to be invalid.",min:"This value should be greater than or equal to %s.",max:"This value should be lower than or equal to %s.",range:"This value should be between %s and %s.",minlength:"This value is too short. It should have %s characters or more.",maxlength:"This value is too long. It should have %s characters or less.",rangelength:"This value length is invalid. It should be between %s and %s characters long.",
